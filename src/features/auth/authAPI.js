...
export function createUser(userData) {
  return new Promise(async (resolve) => {
    const response = await fetch('https://mern-ecommerce-backend-khaki.vercel.app/auth/signup', {
      method: 'POST',
...
export function loginUser(loginInfo) {
  return new Promise(async (resolve, reject) => {
    try {
      const response = await fetch('https://mern-ecommerce-backend-khaki.vercel.app/auth/login', {
        method: 'POST',
